...
public class DPAdapter implements BrokerInterface {
	...
	private void insert(AmbariClient ambari, HashMap<String, String> map) {
		...
		map.put("RANGER_URL", "ABCD");
		map.put("RANGER_ADMIN_USER", "ABCD");
		map.put("RANGER_ADMIN_PASSWORD", "ABCD");
		...
		map.put("AMBARI_HOST", "ABCD");
		map.put("AMBARI_ADMIN_USER", "ABCD");
		map.put("AMBARI_ADMIN_PWD", "ABCD");

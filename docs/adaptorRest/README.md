...
### 2.5.1创建租户（/ocmanager/v2/api/clusters/） 
...
字段|类型|描述|备注|是否常量|
----------|----------------|----|------------|---|
cluster_id|String|cluster id|cluster id|否
cluster_name|String|cluster name|cluster name|否
cluster_type|String|cluster type|cluster type|否
cluster_url|String|cluster url|cluster url|否
cluster_admin|String|cluster admin|cluster admin|否
cluster_password|String|cluster password|cluster password|否
envs|Object|environments|environments|否
...
### 2.5.1创建broker dc（/ocmanager/v2/api/brokers/dc） 
...
### 2.5.2创建broker svc（/ocmanager/v2/api/brokers/svc） 
...
### 2.5.3创建 broker router（/ocmanager/v2/api/brokers/router） 
...
### 2.5.4实例化broker dc（/ocmanager/v2/api/brokers/{id}/dc/instantiate） 
...
### 2.5.5注册broker（/ocmanager/v2/api/brokers/register） 
...
### 2.5.6更新Service broker dc（/ocmanager/v2/api/brokers/{id}/dc） 
...
### 2.5.7删除Service broker（/ocmanager/v2/api/service/broker/{name}/） 
...
### 2.5.8获取broker（/ocmanager/v2/api/brokers/） 
...
### 2.5.9获取broker dc（/ocmanager/v2/api/brokers/{id}/dc） 

...
/**
 * Service Resource, including all resources of a service and their usage
 * condition.
 * 
 * @author EthanWang
 *
...
public class Resource {
	...
	/**
	 * Get all corresponding resources of specified resource type. Returned List
	 * is a copy of source.
	 * 
	 * @param type
	 * @return
	...
	public List<String> getResources(String type) {
		return new ArrayList<String>(resources.row(type).keySet());
	}

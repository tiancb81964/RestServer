...
public class ShellCommandUtil {
	...
	/**
	 * Sets file permissions to a given value on Linux systems. On Windows/Mac,
	 ...
	 * 
	 * @param args
	 *            a String[] of the command and its arguments
	 * @param vars
	 *            a Map of String,String setting an environment variable to run
	 *            the command with
	 * @return Result
	 * @throws IOException
